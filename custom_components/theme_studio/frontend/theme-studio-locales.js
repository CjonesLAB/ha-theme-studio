const TRANSLATIONS = {
  en: {
    "Helles Design": "Light design",
    "Dunkles Design": "Dark design",
    "Name des neuen Designs": "New design name",
    "Modus des neuen Designs": "New design mode",
    "Neues Design erstellen": "Create new design",
    "Galerie-Modus": "Gallery mode",
    "Zu importierende Variante": "Variant to import",
    "Aktiviert dieses Design mit seinem festgelegten Modus.": "Activates this design in its fixed mode.",
    "Neues Design erstellen? Nicht gespeicherte Bearbeitungen werden verworfen.": "Create a new design? Unsaved edits will be discarded.",
    "Es können bis zu 64 eigenständige Designs gespeichert werden.": "Up to 64 independent designs can be saved.",
    "Einstellungen für dieses Design.": "Settings for this design.",
    "Erscheinungsbild": "Appearance",
    "Auto": "Auto",
    "Das Design wird sofort angewendet. Das gespeicherte Ausgangsprofil bleibt unverändert.": "The design is applied immediately. The saved source profile remains unchanged.",
    "Folgt der Hell-/Dunkeleinstellung deines Geräts": "Follows your device's light/dark preference",
    "Speichert und aktiviert dein Design für Hell und Dunkel.": "Saves and activates your design for light and dark modes.",
    ...
    "Dashboard-Vorschau im hellen Modus": "Dashboard preview in light mode",
    "Dashboard-Vorschau im dunklen Modus": "Dashboard preview in dark mode",
    "Hauptfarbe Türkis wählen": "Choose turquoise as primary color",
    "Hauptfarbe Blau wählen": "Choose blue as primary color",
    "Hauptfarbe Grün wählen": "Choose green as primary color",
    "Hauptfarbe Rot wählen": "Choose red as primary color",
    "Hauptfarbe Violett wählen": "Choose violet as primary color",
    ...
    "Gegenmodus erzeugen": "Generate opposite mode",
    ...
    "Änderungen im Profil speichern": "Save profile changes",
    "Umbenennen": "Rename",
    ...
    "Karten": "Cards",
    "Standard": "Standard",
    "Klassische Karten ohne Glasfilter.": "Classic cards without a glass filter.",
    "Transparenz, Unschärfe und Lichtreflexe.": "Transparency, blur, and light reflections.",
    "Liquid Glass steuert Kartenfarbe, Deckkraft, Rahmen und Schatten automatisch.": "Liquid Glass automatically controls card color, opacity, border, and shadow.",
    "Glas-Unschärfe": "Glass blur",
    "Glas-Transparenz": "Glass transparency",
    "Eckenschnitt": "Corner cut",
    "Asymmetrische Kanten und dezente Leuchtlinien.": "Asymmetric edges and subtle light lines.",
    "Farbsättigung hinter dem Glas": "Color saturation behind the glass",
    "Glasreflexion": "Glass reflection",
    ...
    "Sternenfeld und Lichtakzente": "Star field and light accents",
    "Bewegung": "Motion",
  ...
  fr: {
    "Helles Design": "Thème clair",
    "Dunkles Design": "Thème sombre",
    "Name des neuen Designs": "Nom du nouveau thème",
    "Modus des neuen Designs": "Mode du nouveau thème",
    "Neues Design erstellen": "Créer un thème",
    "Galerie-Modus": "Mode de la galerie",
    "Zu importierende Variante": "Variante à importer",
    "Aktiviert dieses Design mit seinem festgelegten Modus.": "Active ce thème dans son mode défini.",
    "Neues Design erstellen? Nicht gespeicherte Bearbeitungen werden verworfen.": "Créer un thème ? Les modifications non enregistrées seront perdues.",
    "Es können bis zu 64 eigenständige Designs gespeichert werden.": "Vous pouvez enregistrer jusqu’à 64 thèmes indépendants.",
    "Einstellungen für dieses Design.": "Réglages de ce thème.",
    "Erscheinungsbild": "Apparence",
    "Auto": "Auto",
    "Das Design wird sofort angewendet. Das gespeicherte Ausgangsprofil bleibt unverändert.": "Le thème est appliqué immédiatement. Le profil source enregistré reste inchangé.",
    "Folgt der Hell-/Dunkeleinstellung deines Geräts": "Suit le mode clair ou sombre de votre appareil",
    "Speichert und aktiviert dein Design für Hell und Dunkel.": "Enregistre et active votre thème pour les modes clair et sombre.",
    ...
    "Vorschaumodus": "Mode d’aperçu",
    "Dashboard-Vorschau im hellen Modus": "Aperçu du tableau de bord en mode clair",
    "Dashboard-Vorschau im dunklen Modus": "Aperçu du tableau de bord en mode sombre",
    "Hauptfarbe Türkis wählen": "Choisir le turquoise comme couleur principale",
    "Hauptfarbe Blau wählen": "Choisir le bleu comme couleur principale",
    "Hauptfarbe Grün wählen": "Choisir le vert comme couleur principale",
    "Hauptfarbe Rot wählen": "Choisir le rouge comme couleur principale",
    "Hauptfarbe Violett wählen": "Choisir le violet comme couleur principale",
    ...
    "☀ Hell": "☀ Clair",
    "☾ Dunkel": "☾ Sombre",
    "Design anwenden": "Appliquer le thème",
    ...
    "Gegenmodus erzeugen": "Générer le mode opposé",
    ...
    "Änderungen im Profil speichern": "Enregistrer les modifications du profil",
    "Umbenennen": "Renommer",
    ...
    "Karten": "Cartes",
    "Standard": "Standard",
    "Klassische Karten ohne Glasfilter.": "Cartes classiques sans filtre de verre.",
    "Transparenz, Unschärfe und Lichtreflexe.": "Transparence, flou et reflets lumineux.",
    "Liquid Glass steuert Kartenfarbe, Deckkraft, Rahmen und Schatten automatisch.": "Liquid Glass règle automatiquement la couleur, l’opacité, la bordure et l’ombre des cartes.",
    "Glas-Unschärfe": "Flou du verre",
    "Glas-Transparenz": "Transparence du verre",
    "Eckenschnitt": "Découpe des angles",
    "Asymmetrische Kanten und dezente Leuchtlinien.": "Bords asymétriques et lignes lumineuses discrètes.",
    "Farbsättigung hinter dem Glas": "Saturation des couleurs derrière le verre",
    "Glasreflexion": "Reflet du verre",
    ...
    "Sternenfeld und Lichtakzente": "Champ d’étoiles et accents lumineux",
    "Bewegung": "Mouvement",
  ...
  es: {
    "Helles Design": "Diseño claro",
    "Dunkles Design": "Diseño oscuro",
    "Name des neuen Designs": "Nombre del nuevo diseño",
    "Modus des neuen Designs": "Modo del nuevo diseño",
    "Neues Design erstellen": "Crear diseño",
    "Galerie-Modus": "Modo de la galería",
    "Zu importierende Variante": "Variante para importar",
    "Aktiviert dieses Design mit seinem festgelegten Modus.": "Activa este diseño en su modo fijo.",
    "Neues Design erstellen? Nicht gespeicherte Bearbeitungen werden verworfen.": "¿Crear un diseño? Se perderán los cambios sin guardar.",
    "Es können bis zu 64 eigenständige Designs gespeichert werden.": "Se pueden guardar hasta 64 diseños independientes.",
    "Einstellungen für dieses Design.": "Ajustes de este diseño.",
    "Erscheinungsbild": "Apariencia",
    "Auto": "Auto",
    "Das Design wird sofort angewendet. Das gespeicherte Ausgangsprofil bleibt unverändert.": "El diseño se aplica inmediatamente. El perfil original guardado permanece sin cambios.",
    "Folgt der Hell-/Dunkeleinstellung deines Geräts": "Sigue el modo claro u oscuro de tu dispositivo",
    "Speichert und aktiviert dein Design für Hell und Dunkel.": "Guarda y activa tu diseño para los modos claro y oscuro.",
    ...
    "Vorschaumodus": "Modo de vista previa",
    "Dashboard-Vorschau im hellen Modus": "Vista previa del panel en modo claro",
    "Dashboard-Vorschau im dunklen Modus": "Vista previa del panel en modo oscuro",
    "Hauptfarbe Türkis wählen": "Elegir turquesa como color principal",
    "Hauptfarbe Blau wählen": "Elegir azul como color principal",
    "Hauptfarbe Grün wählen": "Elegir verde como color principal",
    "Hauptfarbe Rot wählen": "Elegir rojo como color principal",
    "Hauptfarbe Violett wählen": "Elegir violeta como color principal",
    ...
    "☀ Hell": "☀ Claro",
    "☾ Dunkel": "☾ Oscuro",
    "Design anwenden": "Aplicar diseño",
    ...
    "Gegenmodus erzeugen": "Generar modo opuesto",
    ...
    "Änderungen im Profil speichern": "Guardar los cambios del perfil",
    ...
    "Karten": "Tarjetas",
    "Standard": "Estándar",
    "Klassische Karten ohne Glasfilter.": "Tarjetas clásicas sin filtro de cristal.",
    "Transparenz, Unschärfe und Lichtreflexe.": "Transparencia, desenfoque y reflejos de luz.",
    "Liquid Glass steuert Kartenfarbe, Deckkraft, Rahmen und Schatten automatisch.": "Liquid Glass controla automáticamente el color, la opacidad, el borde y la sombra de las tarjetas.",
    "Glas-Unschärfe": "Desenfoque del cristal",
    "Glas-Transparenz": "Transparencia del cristal",
    "Eckenschnitt": "Corte de esquinas",
    "Asymmetrische Kanten und dezente Leuchtlinien.": "Bordes asimétricos y líneas luminosas sutiles.",
    "Farbsättigung hinter dem Glas": "Saturación del color detrás del cristal",
    "Glasreflexion": "Reflejo del cristal",
    ...
    "Sternenfeld und Lichtakzente": "Campo de estrellas y acentos de luz",
    "Bewegung": "Movimiento",
...
function translatePatterns(text, language) {
  const patterns = {
    en: [
      ...
      [/^(.+) geladen\. Zum Aktivieren „Design anwenden“ drücken\.$/, "$1 loaded. Press “Apply design” to activate it."],
      ...
      [/^(.+) wurde geprüft und importiert\. Zum Aktivieren „Design anwenden“ drücken\.$/, "$1 was verified and imported. Press “Apply design” to activate it."],
    ...
    fr: [
      ...
      [/^(.+) geladen\. Zum Aktivieren „Design anwenden“ drücken\.$/, "$1 chargé. Appuyez sur « Appliquer le thème » pour l’activer."],
      ...
      [/^(.+) wurde geprüft und importiert\. Zum Aktivieren „Design anwenden“ drücken\.$/, "$1 a été vérifié et importé. Appuyez sur « Appliquer le thème » pour l’activer."],
    ...
    es: [
      ...
      [/^(.+) geladen\. Zum Aktivieren „Design anwenden“ drücken\.$/, "$1 cargado. Pulsa «Aplicar diseño» para activarlo."],
      ...
      [/^(.+) wurde geprüft und importiert\. Zum Aktivieren „Design anwenden“ drücken\.$/, "$1 se verificó e importó. Pulsa «Aplicar diseño» para activarlo."],
